...
This programmatic example imports the runtime packages directly. The CLI dev server brings its own runtime dependencies, but apps that embed this entry point should install the packages shown below:
