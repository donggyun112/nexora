...
| **Runtime input queue** | 외부 입력의 idempotent enqueue와 claimed/admitted/discarded 전이 | `RuntimeInputQueue`, `RuntimeInputRecord` |
...
ctx_read(path="packages/contracts/src/input-queue.ts", mode="signatures")
